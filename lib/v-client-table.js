...
exports.install = function(Vue, globalOptions, customOptions) {
  ...
  var client = {
    ...
    created: function() {
       ...
       * methods = events, filters = global filters
       * */
      //bind methods form options to this instance
      /*var _ = require('lodash');
      _.each(this.options.methods, function (method, methodName) {
        //bind only if it doesn't override existing object keys
